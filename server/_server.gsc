...
broadcastVersion(){
	...
	level.rotuVersion = "RotU-Revolution Alpha 0.2.1 (03:23 26.11.2013)";
	level.rotuVersion_short = "RotU-R Alpha 0.2.1 (03:23 26.11.2013)";
	level.rotuVersion_hostname = "RotU-Revolution 0.2.1-alpha";
	level.rotuVersion_hostname_short = "0.2.1-alpha";
	while(1){
